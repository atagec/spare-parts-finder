...
class App(customtkinter.CTk):
    ...
    def searchPart(self):
        # self.data = ["MARKA", "ÜRETİCİ KODU ", "OEM", "ÜRÜN ADI", "AÇIKLAMA", "İÇERİK", "ARAÇ TİPİ", "MOTOR TİPİ", "LİSTE FİYAT", "KDV'Lİ MALİYET", "STOK"]
        ...
        # self.table.grid(row=1, column=1, padx=(20, 0), pady=(20, 0), sticky="nsew", rowspan=2)
        self.table.grid(row=1, rowspan=1, column=0, columnspan=3, sticky="wens", padx=(0, 0), pady=(0, 0))
        # self.table.grid(row=0, column=2, padx=(20, 0), pady=(20, 0), sticky="nsew", rowspan=2)
